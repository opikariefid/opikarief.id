    ...
    var j = function(a) {
        ...
        g = function(z) {
            ...
            for (var q = 0; q < d.numPosts; q++) {
                ...
                if (A == 2) {
                    c += '<div><a class="title" title="' + t + ' href="' + v + '"' + b + '>' + w + '</a><div><img alt="' + t + '" class="image" src="' + r + '" style="width:' + d.thumbnailSize + ';height:' + d.thumbnailSize + '" title="' + t + '"><div class="desc">' + u + '</div>' + y + '</div><div class="jumplink"><a href="' + v + ' class="more" ' + b + '>' + d.moreText + '</a></div></div>'
                } else {
                    if (A == 3 || A == 4) {
